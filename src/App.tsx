...
const CTA = () => (
  <section className="py-16 md:py-32 bg-vestora-white dark:bg-[#0B120E] border-t border-vestora-sage/20 transition-colors duration-300 relative overflow-hidden">
    <FloatingParticles />
